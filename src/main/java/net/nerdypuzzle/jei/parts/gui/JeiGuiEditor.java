...
public class JeiGuiEditor extends JPanel {
    ...
    public final JeiGui editor = new JeiGui(this);
    ...
    public BufferedImage guiImage;

    public JeiGuiEditor(final MCreator mcreator) {
        ...
        list.setCellRenderer(new JeiGuiEditor.GUIComponentRenderer());
            ...
            componentButton.addActionListener(e -> {
                try {
                    componentRegistration.editor()
                            .getConstructor(JeiGuiEditor.class, componentRegistration.component())
